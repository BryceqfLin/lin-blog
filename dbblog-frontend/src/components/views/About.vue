<template>
  <div class="about">
    ...
    <p class="name">Bryce</p>
    <p class="desc">The more you know, the more you don't know</p>
    <ul class="social">
      <li><a href="https://github.com/BryceqfLin" target="_blank"><img src="../../assets/icon/GitHub.png" alt=""></a></li>
    </ul>
    <div class="line"></div>
    <h4>技能值</h4>
